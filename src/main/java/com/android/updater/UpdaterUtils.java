...
public class UpdaterUtils {
    ...
    public static boolean compare(Context context, String path) {
        ...
        try {
            ...
            if (UpdateLogger.get().getShowLog()) {
                UpdateLogger.get().e("apk file packageName=" + apkInfo.packageName + ",versionName=" + apkInfo.versionName);
                UpdateLogger.get().e("current app packageName=" + packageInfo.packageName + ",versionName=" + packageInfo.versionName);
